            ...
            <div className="rounded-[24px] overflow-hidden bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border border-white/[0.06] p-8 md:p-10 flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1">
                ...
                <p className="text-white/45 text-sm leading-relaxed mt-3 max-w-[560px]">
                  This storefront was first composed in Stitch (stitch.withgoogle.com) — exploring a bento category grid, glassmorphism, and cinematic hero hierarchy — then implemented as production React + Three.js with lazy 3D, Suspense, GPU-friendly motion and Lenis smooth scrolling.
                </p>
                <div className="mt-5 flex flex-wrap gap-2 text-[11px] tracking-widest uppercase text-white/30">
                  <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10">Lenis 1.3</span>
